...
open Dap.Myra.Internal

let mutable private param : ApplicationParam =
    ApplicationParam.Create (name = "Dap.Myra", title = "Myra Application", clearColor = Color.Black, exitKey = Keys.Escape)
